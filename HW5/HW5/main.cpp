...
void MoreTests() {
  ...
  cout << "Testing erase of last element:" << endl;
  a.print(cout);
  cout << endl;
  ...
  cout << "Testing erase of last node:" << endl;
  a.print(cout);
  cout << endl;
  ...
  cout << "Testing insert at beginning of list:" << endl;
  a.print(cout);
  cout << endl;
  ...
  cout << "Testing insert at end of list:" << endl;
  a.print(cout);
  cout << endl;
  ...
  cout << "Testing consecutive erases:" << endl;
  a.print(cout);
  cout << endl;

  for (UnrolledLL<int>::iterator itr = a.begin(); itr != a.end(); itr++) {
      if ((*itr == 4) || (*itr == 5) || (*itr == 6) || (*itr == 7)) {
          itr = a.insert(itr, 88);
          itr++;
      }
  }

  cout << "Testing consecutive inserts: " << endl;
  a.print(cout);
  cout << endl;
